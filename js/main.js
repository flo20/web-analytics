(function($) {
  ...
  //hide popup1 when user clicks on the close button
  document.getElementById("popup1").getElementsByClassName("close")[0].addEventListener("click", function() {
      document.getElementById("popup1").style.visibility = "hidden";
    });

  //When user clicks on the Submit button, perform an input validation to make sure that it is a valid email.
  // Show user a success message by displaying the popup2 element and hide popup1 away
